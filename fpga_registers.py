...
REGISTERS: list[RegisterDef] = [
    ...
    RegisterDef("Upper lim Z",            Category.Z_AXIS, description="Upper saturation limit Z"),
    RegisterDef("Lower lim Z",            Category.Z_AXIS, description="Lower saturation limit Z"),
    ...
    RegisterDef("DC offset Z",            Category.Z_AXIS, description="DC offset added to Z feedback"),
    ...
    RegisterDef("Z before Setpoint",      Category.Z_AXIS, description="Z before-chamber setpoint"),
    ...
    RegisterDef("Lower lim Z before",     Category.Z_AXIS, description="Lower limit Z (before chamber)"),
    RegisterDef("Upper lim Z before",     Category.Z_AXIS, description="Upper limit Z (before chamber)"),
    ...
    # --- Y axis ---
    RegisterDef("Y Setpoint",             Category.Y_AXIS, description="Y feedback setpoint"),
    ...
    RegisterDef("Upper lim Y",            Category.Y_AXIS, description="Upper saturation limit Y"),
    RegisterDef("Lower lim Y",            Category.Y_AXIS, description="Lower saturation limit Y"),
    ...
    RegisterDef("DC offset Y",            Category.Y_AXIS, description="DC offset added to Y feedback"),
    ...
    RegisterDef("Y before Setpoint",      Category.Y_AXIS, description="Y before-chamber setpoint"),
    ...
    RegisterDef("Lower lim Y before",     Category.Y_AXIS, description="Lower limit Y (before chamber)"),
    RegisterDef("Upper lim Y before",     Category.Y_AXIS, description="Upper limit Y (before chamber)"),
    ...
    # --- X axis ---
    RegisterDef("X Setpoint",             Category.X_AXIS, description="X feedback setpoint"),
    ...
    RegisterDef("Upper lim X",            Category.X_AXIS, description="Upper saturation limit X"),
    RegisterDef("Lower lim X",            Category.X_AXIS, description="Lower saturation limit X"),
    ...
    RegisterDef("DC offset X",            Category.X_AXIS, description="DC offset added to X feedback"),
    ...
    RegisterDef("X before Setpoint",      Category.X_AXIS, description="X before-chamber setpoint"),
    ...
    RegisterDef("Lower lim X before",     Category.X_AXIS, description="Lower limit X (before chamber)"),
    RegisterDef("Upper lim X before",     Category.X_AXIS, description="Upper limit X (before chamber)"),
    ...
    RegisterDef("offset",                 Category.COM_OUTPUT, description="COM output offset"),
    RegisterDef("amplitude",              Category.COM_OUTPUT, description="COM output amplitude"),
    RegisterDef("frequency (periods/tick)", Category.COM_OUTPUT, description="COM output frequency"),
    ...
    RegisterDef("frequency AO4",          Category.AO_CHANNELS, description="AO4 frequency"),
    RegisterDef("reset AO4",              Category.AO_CHANNELS, is_bool=True, description="Reset AO4"),
    RegisterDef("phase offset AO4",       Category.AO_CHANNELS, description="AO4 phase offset"),
    RegisterDef("Amplitude AO4",          Category.AO_CHANNELS, description="AO4 amplitude"),
    RegisterDef("frequency AO5",          Category.AO_CHANNELS, description="AO5 frequency"),
    RegisterDef("reset AO5",              Category.AO_CHANNELS, is_bool=True, description="Reset AO5"),
    RegisterDef("phase offset AO5",       Category.AO_CHANNELS, description="AO5 phase offset"),
    RegisterDef("Amplitude AO5",          Category.AO_CHANNELS, description="AO5 amplitude"),
    RegisterDef("frequency AO6",          Category.AO_CHANNELS, description="AO6 frequency"),
    RegisterDef("reset AO6",              Category.AO_CHANNELS, is_bool=True, description="Reset AO6"),
    RegisterDef("phase offset AO6",       Category.AO_CHANNELS, description="AO6 phase offset"),
    RegisterDef("Amplitude AO6",          Category.AO_CHANNELS, description="AO6 amplitude"),
    RegisterDef("frequency AO7",          Category.AO_CHANNELS, description="AO7 frequency"),
    RegisterDef("reset AO7",              Category.AO_CHANNELS, is_bool=True, description="Reset AO7"),
    RegisterDef("phase offset AO7",       Category.AO_CHANNELS, description="AO7 phase offset"),
    RegisterDef("Amplitude AO7",          Category.AO_CHANNELS, description="AO7 amplitude"),
]
